...
function ReturnFormPage() {
  ...
  const isSubmitDisabled = useMemo(() => {
    ...
    return false;
  }, [orderItemId, orderId, submitting, formData, isReturn, bankInfoConfirmed]);
      ...
      <div className="min-h-screen bg-[#fcfcfc] pt-24 px-6 pb-16">
        <div className="max-w-md mx-auto bg-white rounded-2xl p-8 shadow-sm border border-slate-100 text-center">
          ...
          >
            <FiAlertCircle
              size={32}
              className={existingStatusInfo?.iconColor}
            />
          </div>
                  ...
                  <div className="pt-1">
                    <label className="flex items-start gap-3 cursor-pointer select-none">
                      ...
                      <span className="text-sm font-medium text-slate-600 leading-relaxed">
                        Please check that the bank account information is
                        correct.
                      </span>
                    </label>
                  </div>
  ...
  switch (status) {
    ...
    case "REFUNDED":
      return {
        label: "Refunded",
        message:
          "The shop has transferred your refund. Please confirm after you receive the money.",
        badgeClass: "bg-emerald-100 text-emerald-700",
        iconBg: "bg-emerald-50",
        iconColor: "text-emerald-500",
      };
    case "REFUND_RECEIVED_CONFIRMED":
    case "CUSTOMER_CONFIRMED_REFUND":
    case "CUSTOMER_REFUND_CONFIRMED":
    case "WAITING_ADMIN_REFUND_CONFIRM":
      return {
        label: "Waiting Admin Confirmation",
        message:
          "You confirmed receiving the refund. The shop is doing a final confirmation.",
    ...
    case "REFUND_FINALIZED":
      return {
        ...
        message:
          "Refund flow has been completed and your order is marked as REFUND.",
